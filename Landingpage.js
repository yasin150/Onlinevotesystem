...
const Landingpage = () => {
  ...
  return (
    ...
    <div className="ml-10  py-32 px-8">
        ...
        <p className="py-5 w-1/3 text-white">An online voting system allows people to cast their votes electronically using the internet. It ensures a secure, fast, and convenient way to participate in elections, replacing traditional paper-based voting methods.</p>
        <div className=" my-4 ">
